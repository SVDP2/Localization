...
def generate_launch_description() -> LaunchDescription:
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('wheelbase_m', default_value='0.722'),
        DeclareLaunchArgument('track_width_m', default_value='0.660'),
        DeclareLaunchArgument('wheel_radius_m', default_value='0.115'),
        DeclareLaunchArgument('wheel_width_m', default_value='0.100'),
