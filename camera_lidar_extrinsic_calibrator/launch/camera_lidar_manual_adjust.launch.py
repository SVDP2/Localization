...
def generate_launch_description():
    ...
    default_params = os.path.join(package_share, 'config', 'manual_adjuster.yaml')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('initial_extrinsic_file', default_value=default_extrinsic),
        ...
        Node(
            ...
            executable='camera_lidar_manual_adjust_node',
            name='camera_lidar_manual_adjust_node',
            output='screen',
            emulate_tty=True,
            parameters=[
                params_file,
